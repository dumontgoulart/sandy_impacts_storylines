...
# module load slk (ls -lh, sbatch,  squeue -u g260212)
# slk login (use gnumber 260212 and levante password)
# Send this script from pc to server <scp -r D:\paper_3\code\SLKretrieve_tape_2014.sh g260212@levante.dkrz.de:/work/gg0301/from_Mistral/gg0301/g260212/>

#SBATCH --job-name=2014_retrieval  					 # Specify job name
#SBATCH --output=2014_retrieval.%j                # name for standard output log file, same as job-name
#SBATCH --error=2014_retrieval.%j                 # name for standard error output log file, it is better it is the same as ouput
