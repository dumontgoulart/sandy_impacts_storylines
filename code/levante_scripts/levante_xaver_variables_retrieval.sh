...
# 4) Local computer: Load files from server to pc <scp -r g260212@levante.dkrz.de:/work/gg0301/from_Mistral/gg0301/g260212/xaver D:/paper_3/data/spectral_nudging_data>
################################################################################
# Load module
module load cdo
module load nco
...
declare -a storm=("xaver") # string format
declare -a months=("12") # string format with a zero before for single digits
declare -a year=("2013") # string format
declare -a bbox=("-63.982422,36.826172,22.979488,69.886265") # lon_min,lon_max,lat_min,lat_max -63.984375,22.431340,29.707031,69.037142
################################################################################
# Variables
suffix=151
declare -a var=("mslp")
