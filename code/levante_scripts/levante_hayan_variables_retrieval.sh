...
# STEPS:
# 1) Send this script from pc to server <scp -r D:\paper_3\code\levante_hayan_variables_retrieval.sh g260212@levante.dkrz.de:/work/gg0301/from_Mistral/gg0301/g260212/>
# 2) Access Levante (id g260212@levante.dkrz.de)
# 3) Run on Levante terminal: <bash levante_hayan_time_sellonlat_precip.sh>
# 4) Local computer: Load files from server to pc <scp -r g260212@levante.dkrz.de:/work/gg0301/from_Mistral/gg0301/g260212/hayan D:/paper_3/data/spectral_nudging_data>
################################################################################
# Load module
module load cdo
module load nco
...
declare -a storm=("hayan") # string format
declare -a months=("11") # string format with a zero before for single digits
declare -a year=("2013") # string format
declare -a bbox=("100.810547,170.859375,-2.723583,27.371767") # lon_min,lon_max,lat_min,lat_max 100.810547,-2.723583,170.859375,27.371767
################################################################################
# Variables
suffix=151
declare -a var=("mslp")
