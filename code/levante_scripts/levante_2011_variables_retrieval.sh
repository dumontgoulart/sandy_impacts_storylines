...
declare -a storm=("season_2011") # string format
declare -a months=("08" "09" "10") # string format with a zero before for single digits
declare -a year=("2011") # string format
declare -a bbox=("-89.472656,-30.078125,7.532249,55.429222") # lon_min,lon_max,lat_min,lat_max -89.472656,7.536764,-30.585938,54.572062
################################################################################
# Variables
suffix=151
declare -a var=("mslp")
