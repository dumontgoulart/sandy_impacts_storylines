...
declare -a storm=("megi") # string format
declare -a months=("10") # string format with a zero before for single digits
declare -a year=("2010") # string format
declare -a bbox=("115.224609,141.240234,5.528511,24.846565") # lon_min,lon_max,lat_min,lat_max 115.224609,5.528511,141.240234,24.846565
