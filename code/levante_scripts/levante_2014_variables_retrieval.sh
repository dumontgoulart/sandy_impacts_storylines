...
declare -a storm=("season_2014") # string format
declare -a months=("10") # string format with a zero before for single digits
declare -a year=("2014") # string format
declare -a bbox=("-89.472656,-40.078125,9.232249,55.429222") # lon_min,lon_max,lat_min,lat_max -89.472656,9.232249,-40.078125,48.458352
################################################################################
# Variables
suffix=151
declare -a var=("mslp")
