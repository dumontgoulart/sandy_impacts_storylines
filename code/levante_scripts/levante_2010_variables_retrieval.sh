...
# STEPS:
# 1) Send this script from pc to server <scp -r D:\paper_3\code\levante_2010_variables_retrieval.sh g260212@levante.dkrz.de:/work/gg0301/from_Mistral/gg0301/g260212/>
...
declare -a storm=("season_2010") # string format
declare -a months=("08" "09") # string format with a zero before for single digits
declare -a year=("2010") # string format
declare -a bbox=("-89.472656,-30.078125,7.532249,55.429222") # lon_min,lon_max,lat_min,lat_max -90.175781,9.232249,-46.713867,43.100983
################################################################################
# Variables
suffix=151
declare -a var=("mslp")
