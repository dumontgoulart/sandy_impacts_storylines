...
# STEPS:
# 1) Send this script from pc to server <scp -r D:\paper_3\code\levante_xynthia_variables_retrieval.sh g260212@levante.dkrz.de:/work/gg0301/from_Mistral/gg0301/g260212/>
# 2) Access Levante (id g260212@levante.dkrz.de)
# 3) Run on Levante terminal: <bash levante_xynthia_variables_retrieval.sh>
# 4) Local computer: Load files from server to pc <scp -r g260212@levante.dkrz.de:/work/gg0301/from_Mistral/gg0301/g260212/xynthia D:/paper_3/data/spectral_nudging_data>
################################################################################
# Load module
module load cdo
module load nco
...
declare -a storm=("xynthia") # string format
declare -a months=("02" "03") # string format with a zero before for single digits
declare -a year=("2010") # string format
declare -a bbox=("-180,180,-90,90") # lon_min,lon_max,lat_min,lat_max -65.917969,22.431340,29.707031,64.472794
################################################################################
# Variables
suffix=151
declare -a var=("mslp")
...
# 	done;
# done;
# 4) Local computer: Load files from server to pc <scp -r g260212@levante.dkrz.de:/work/gg0301/from_Mistral/gg0301/g260212/sandy/U10_m_s D:/paper_3/data/spectral_nudging_data/sandy>
