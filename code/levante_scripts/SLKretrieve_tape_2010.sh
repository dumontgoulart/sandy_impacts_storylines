...
#SBATCH --job-name=storm_2010   					 # Specify job name
#SBATCH --output=storm_2010.%j                # name for standard output log file, same as job-name
#SBATCH --error=storm_2010.%j                 # name for standard error output log file, it is better it is the same as ouput
