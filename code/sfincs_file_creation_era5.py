...
storm = 'xynthia'  #sandy_slr10 sandy_historical
...
for scenario in scenarios:
    ...
    if '_slr' in storm:     
        ...
        clip.data_catalog_edit(f'd:/paper_3/data/sfincs_ini/data_gtsm_test.yml', 'gtsm_spectral_nudging_waterlevel_template', f'gtsm_{type_of_data}_{scenario}_{storm}_waterlevel', f'd:/paper_3/data/gtsm_outputs/{storm}/gtsm_fine_{storm}_{scenario}_0000_his_waterlevel.nc')
        ...
        clip.data_catalog_edit(f'd:/paper_3/data/sfincs_ini/data_gtsm_test.yml', 'gtsm_spectral_nudging_waterlevel_template', f'gtsm_{type_of_data}_{scenario}_{storm}_waterlevel', f'd:/paper_3/data/gtsm_outputs/gtsm_{storm}_waterlevel_2010-02-25_2010-03-02.nc')
